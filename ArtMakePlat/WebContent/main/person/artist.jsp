...
var flag;
	...
	function goMessage(){
	       window.location.href = "message?id=<s:property value='person.person_id'/>";
	}
		...
		<div class="row">
			...
			<div class="blog">
				<table>
					<tbody>
						<tr>
							<td width="50%"><div class="fa fa-user"></div> <s:if
									test="person.realname == ''">
									<s:property value="person.account" />
								</s:if> <s:else>
									<s:property value="person.realname" />
								</s:else></td>
							<td width="50%"><s:if test="#session.person.person_id == person.person_id">
						...
						<tr>
							<td width="50%"><div class="fa fa-bookmark"></div> <s:iterator
                ...
                &nbsp;&nbsp;<label style="cursor: pointer" id="upbtn"
						...
						<tr>
							<td width="50%"><div class="fa fa-comments"></div><label style="cursor:pointer" onclick="goMessage()">信息</label></td>
							<td width="50%"><s:if
									test="#session.person.person_id == person.person_id">
