...
<script type="text/javascript" src="js/backstage/jquery/jquery-1.4.4.min.js"></script>
<script src="js/backstage/My97DatePicker/WdatePicker.js" type="text/javascript" defer="defer"></script>
		...
		<div id="nav_links">
			...
			<div id="page_close">
				<a href="javascript:parent.$.fancybox.close();">
					<img src="images/backstage/common/page_close.png" width="20" height="20" style="vertical-align: text-top;"/>
				</a>
			</div>
		</div>
