...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $("#addBtn").fancybox({
	        ...
	        'onClosed' : function() { 
	        	window.location.href = 'forward!goInfolist';
	        }
	    });
...
// 				return;
	...
	function jumpNormalPage(page){
		$("#submitForm").attr("action", "forward!goInfolist?page=" + page).submit();
	}
	...
	function jumpInputPage(totalPage){
		...
		if($("#jumpNumTxt").val() != ''){
			...
			$("#submitForm").attr("action", "forward!goInfolist?page=" + pageNum).submit();
		}else{
			// “跳转页数”为空
			art.dialog({icon:'error', title:'友情提示', drag:false, resize:false, content:'请输入合适的页数，\n自动为您跳到首页', ok:true,});
			$("#submitForm").attr("action", "forward!goInfolist?page=" + 1).submit();
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						<tr>
							...
							<tr>
								...
								<td>建成待租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458579642011" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>已配租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458625716623" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>建成待租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458592537463" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>建成待租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458632171244" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>建成待租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458599318263" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>建成待租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458638753194" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>建成待租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458606278350" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>已配租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458644830000" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>建成待租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458612828548" class="edit">编辑</a> 
							...
							<tr>
								...
								<td>已配租</td>
								<td>
									<a href="forward!goInfoedit?fyID=14458619251417" class="edit">编辑</a> 
