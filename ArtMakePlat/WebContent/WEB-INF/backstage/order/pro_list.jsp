...
$(document).ready(function(){    
    ...
    $("#selectpname").val(pro[2]);
});
	/** 模糊查询  **/
	function search(){
		$("#submitForm").attr("action", "orderManage!goPro").submit();
	}
	...
	function jumpNormalPage(page,key){
		if(jumpPage(page,key)){
			$("#submitForm").attr("action", "orderManage!goPro?PAGE="+ page).submit();
		}
	}
				...
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							...
							申请人账号<input type="text" id="selectaccount" name="selectpro" class="ui_input_txt02" />
						         艺术品名<input type="text" id="selectpname" name="selectpro" class="ui_input_txt02" />
						</div>
						<div id="box_bottom">
					...
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<s:iterator value="orderList" id="row">
							<tr>
							    ...
							    <td><s:property value="#row.product.price"/></td>
