		...
		$.ajax({
	        ...
	        success: function(data){
	        	...
	        	if(data.person_id == 0){
	        		...
	        		alert("信息为:" +
	        				"\nrealname:"+ (data.realname=="null"?"":data.realname) +
	        				"\nsex:" + (data.sex=="null"?"无":data.sex) +
	        				"\nemail:" + (data.email=="null"?"无":data.email) + 
	        				"\ntel:" + (data.tel=="null"?"无":data.tel) + 
	        				"\naddress:" + (data.address=="null"?"无":data.address) +
	        				"\nintroduce:" + (data.introduce=="null"?"无":data.introduce));
	        	}
	        },
...
<section id="content" class="gallery"><div class="ic">More Website Templates @ TemplateMonster.com - August11, 2014!</div>
  <div class="container">
    <div class="row">
          ...
          <tbody>
            ...
            <tr>
              ...
              <s:if test="person.state == 0">
                 &nbsp;&nbsp;<label style="cursor:pointer" id="upbtn" onclick="upAuth()">升级申请</label>
              </s:if>
              <s:else>
                &nbsp;&nbsp;<label style="cursor:pointer" id="upbtn" onclick="upAuth()">取消申请</label>
              </s:else>
              </s:if>
              </s:if>
              </td>
            ...
            <tr>
              ...
              <td colspan="2">
              <s:if test="#session.person.person_id == person.person_id">
              <a href="person!goImprove"><div class="fa fa-eye"></div> 修改信息 >>
              </a>
              </s:if>
              <s:else>
              <a href="javascript:goshow()"><div class="fa fa-eye"></div> 查看信息 >>
              </a>
              </s:else>
            </tr>
          </tbody>
      ...
      <div align="center" style="font-size:20px"> &lt;&lt;&nbsp;&nbsp;&nbsp;&nbsp;1&nbsp;&nbsp;&nbsp;&nbsp;&gt;&gt; </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="uploadArt.html" class="gall_item"><img src="images/transparent.png" alt=""><span></span></a>
          <div class="box_bot">
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big2.jpg" class="gall_item"><img src="images/page3_img2.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">私人艺术品1</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">上架</a>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big3.jpg" class="gall_item"><img src="images/page3_img3.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">私人艺术品2</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">上架</a>
            <a href="#" class="btn">删除</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big4.jpg" class="gall_item"><img src="images/page3_img4.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">私人艺术品3</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">上架</a>
            <a href="#" class="btn">删除</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big5.jpg" class="gall_item"><img src="images/page3_img5.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">私人艺术品4</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">上架</a>
            <a href="#" class="btn">删除</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big6.jpg" class="gall_item"><img src="images/page3_img6.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">私人艺术品5</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">上架</a>
            <a href="#" class="btn">删除</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big1.jpg" class="gall_item"><img src="images/page3_img1.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">流拍1</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">收回</a>
            <a href="#" class="btn">上架</a>
          </div>
        </div>
      </div>
      <div class="grid_4">
        <div class="box">
          <a href="images/big2.jpg" class="gall_item"><img src="images/page3_img2.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">流拍2</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">收回</a>
            <a href="#" class="btn">上架</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big3.jpg" class="gall_item"><img src="images/page3_img3.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">流拍3</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">收回</a>
            <a href="#" class="btn">上架</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big4.jpg" class="gall_item"><img src="images/page3_img4.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">流拍4</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">收回</a>
            <a href="#" class="btn">上架</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big5.jpg" class="gall_item"><img src="images/page3_img5.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">流拍5</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">收回</a>
            <a href="#" class="btn">上架</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          <a href="images/big6.jpg" class="gall_item"><img src="images/page3_img6.jpg" alt=""></a>
          <div class="box_bot">
            <div class="box_bot_title">流拍6</div>
            <p>Dorem ipsum dolor sit amet, consectetur adipiscing elit. In mollis erat mattis neque facilisis, sit amet ultricies erat rutrum. Cras facilisis, nulla vel viverra auctor, leo magna sodales felis, quis malesuada nibh odio ut velit</p>
            <a href="#" class="btn">收回</a>
            <a href="#" class="btn">上架</a>
          </div>
      ...
      <div class="grid_4">
        <div class="box">
          ...
          <div class="box_bot">
            ...
            <a href="#" class="btn">联系用户</a>
            <a href="#" class="btn">终止</a>
            <p>一些注意事项</p>
          </div>
        </div>
      </div>
